  ...
  return (
    <section id="contact" className="container mx-auto py-14 font-primary select-none">
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-x-18 lg:gap-x-12">
        ...
        <a href="https://github.com/mehdihmr" target="_blank" className="rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" className="rounded-full text-primary hover:text-accent cursor-pointer" fill="currentColor" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
        ...
        <a href="https://www.linkedin.com/in/mehdi-hamrouni-41989116b/" target="_blank" className="rounded-xl">
          <svg xmlns="http://www.w3.org/2000/svg" className="rounded-xl text-primary hover:text-accent cursor-pointer" fill="currentColor" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
