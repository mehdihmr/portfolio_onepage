    ...
    <header>
      <div className="fixed top-0 left-0 right-0 backdrop-blur-md border-b border-border h-14 select-none z-40 font-primary">
        ...
        <div className="h-full w-1/2 mx-auto hidden lg:flex flex-row items-center justify-center gap-x-6">
          ...
          <a href="#skills" type="button" className="cursor-pointer text-primary hover:text-accent z-50">
            SKILLS
          </a>
          <a href="#about" type="button" className="cursor-pointer text-primary hover:text-accent z-50">
            ABOUT
          </a>
          <a href="#contact" type="button" className="cursor-pointer text-primary hover:text-accent z-50">
            CONTACT
          </a>
        </div>
      </div>
